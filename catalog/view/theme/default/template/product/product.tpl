                            ...
                            <div class="options">
                                ...
                                <?php break;case 'color': ?>
                                    ...
                                    <select id="product-color" name="option[<?php echo $option['product_option_id']; ?>]" onchange="changeUrl();">
                                        ...
                                        <option selected="selected" value="#"><?php echo $option_value['name']; ?></option>
                                        <?php } else {?>
                                        <option value="<?php echo $option_value['href']; ?>"><?php echo $option_value['name']; ?></option>
                                        <?php }?>
                                        <?php } ?>
                                    </select>
                                ...
                                <?php break;case 'text': ?>
                                    <b><?php echo $option['name']; ?>:</b><br />
                                    <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" placeholder="<?php echo $option['option_value']; ?>" />
                                <?php break;case 'textarea':?>
                                    <b><?php echo $option['name']; ?>:</b><br />
                                    <textarea name="option[<?php echo $option['product_option_id']; ?>]" cols="40" rows="5" placeholder="<?php echo $option['option_value']; ?>"></textarea>
                                <?php break;case 'file': ?>
                                    <b><?php echo $option['name']; ?>:</b><br />
