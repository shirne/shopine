...
class ControllerProductSearch extends Controller { 	
	public function index() { 
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$url = $this->url->buildQuery($this->request->get,'filter_name,filter_tag,filter_description,filter_category_id,filter_sub_category,sort,order,page,limit');
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_tag'])) {
			...
			$url = $this->url->buildQuery($this->request->get,'filter_name,filter_tag,filter_description,filter_category_id,filter_sub_category,limit');
			...
			$url = $this->url->buildQuery($this->request->get,'filter_name,filter_tag,filter_description,filter_category_id,filter_sub_category,sort,order');
			...
			$url = $this->url->buildQuery($this->request->get,'filter_name,filter_tag,filter_description,filter_category_id,filter_sub_category,sort,order,limit');
