...
class ControllerReportSale extends Controller { 
	public function index() {  
		...
		$url = $this->url->buildQuery($this->request->get,"filter_date_start,filter_date_end,filter_group,filter_order_status_id,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_date_start,filter_date_end,filter_group,filter_order_status_id");
