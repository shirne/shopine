...
class ControllerReportCustomerReward extends Controller {
	public function index() {     
		...
		$url = $this->url->buildQuery($this->request->get,"filter_date_start,filter_date_end,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_date_start,filter_date_end");
