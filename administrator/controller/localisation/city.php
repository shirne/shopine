...
class ControllerLocalisationCity extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$url = $this->url->buildQuery($this->request->get,"filter_zone,filter_city,filter_code,filter_country_id,filter_status,sort,order,page");
	...
	private function getList() {
		...
		$url = $this->url->buildQuery($this->request->get,"filter_zone,filter_city,filter_code,filter_country_id,filter_status,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_zone,filter_city,filter_code,filter_country_id,filter_status,sort,order");
