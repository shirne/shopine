...
class ControllerCatalogProduct extends Controller {
	private $error = array();
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$url = $this->url->buildQuery($this->request->get,"filter_name,filter_model,filter_sku,filter_price,filter_quantity,filter_status,filter_category_id,sort,order,page");
  	...
  	private function getList() {
		...
		$url = $this->url->buildQuery($this->request->get,"filter_name,filter_model,filter_sku,filter_price,filter_quantity,filter_status,filter_category_id,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_name,filter_model,filter_sku,filter_price,filter_quantity,filter_status,filter_category_id,sort,order");
  	...
  	private function getForm() {
		...
		if (isset($this->request->post['product_option'])) {
			...
			$product_options = $this->model_catalog_product->getProductInitOptions();
		}

		$this->data['product_options'] = array();

		foreach ($product_options as $product_option) {
			if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' ||$product_option['type'] == 'virtual_product' ||$product_option['type'] == 'color' ||$product_option['type'] == 'text'  ) {
	...
	public function unionOption() {
        ...
        $results = $this->model_catalog_option->getUnionOptionValues($this->request->get['option_id']);
