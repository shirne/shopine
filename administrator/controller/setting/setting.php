...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$error_keys=array(
			...
			'image_article' => 'error_image_article',
			'image_article_category' => 'error_image_article_category',
		...
		$post_keys=array(
			...
			'config_image_article_width',
			'config_image_article_height',
			'config_image_article_category_width',
			'config_image_article_category_height',
	...
	private function validate() {
		...
		if (!$this->request->post['config_image_article_category_width'] || !$this->request->post['config_image_article_category_height']) {
