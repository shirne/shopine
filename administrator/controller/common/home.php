...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		$this->data['add_article'] = $this->url->link('article/article/insert', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['article_category'] = $this->url->link('article/category', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['add_article_category'] = $this->url->link('article/category/insert', 'token=' . $this->session->data['token'], 'SSL');
