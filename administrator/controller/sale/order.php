	...
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$url = $this->url->buildQuery($this->request->get,"filter_order_id,filter_customer,filter_order_status_id,filter_total,filter_date_added,filter_date_modified,sort,order,page");
  	...
  	private function getList() {
		...
		$url = $this->url->buildQuery($this->request->get,"filter_order_id,filter_customer,filter_order_status_id,filter_total,filter_date_added,filter_date_modified,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_order_id,filter_customer,filter_order_status_id,filter_total,filter_date_added,filter_date_modified,sort,order");
