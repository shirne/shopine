...
class ControllerSaleCustomer extends Controller { 
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$url = $this->url->buildQuery($this->request->get,"filter_name,filter_email,filter_customer_group_id,filter_status,filter_approved,filter_ip,filter_date_added,sort,order,page");
	...
	public function approve() {
  	...
  	private function getList() {
		...
		$url = $this->url->buildQuery($this->request->get,"filter_name,filter_email,filter_customer_group_id,filter_status,filter_approved,filter_ip,filter_date_added,page");
		...
		$url = $this->url->buildQuery($this->request->get,"filter_name,filter_email,filter_customer_group_id,filter_status,filter_approved,filter_ip,filter_date_added,sort,order");
