...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			if(empty($value['title']))$value['title']=$data['name'];
	...
	public function getManufacturers($data = array()) {
		if ($data) {
			...
			if (!$manufacturer_data) {
				$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "manufacturer m LEFT JOIN " . DB_PREFIX . "manufacturer_description md on (m.manufacturer_id=md.manufacturer_id) ORDER BY name");
