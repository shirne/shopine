          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><textarea name="welcome_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" class="editor"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
...
function addModule() {	
	...
	html += '        <tr>';
	html += '          <td width="80"><?php echo $entry_description; ?></td>';
	html += '          <td><textarea name="welcome_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" class="editor"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '  <table class="form">';
	html += '    <tr>';
	html += '      <td width="80"><?php echo $entry_layout; ?></td>';
	...
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td width="80"><?php echo $entry_position; ?></td>';
	...
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td width="80"><?php echo $entry_status; ?></td>';
	...
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td width="80"><?php echo $entry_sort_order; ?></td>';
	...
	<?php echo strip_tags($editorinit);?>
