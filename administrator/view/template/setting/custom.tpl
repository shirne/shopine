    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_admin_editor; ?></td>
              <td><select name="config_admin_editor">
                  <?php foreach ($editors as $editor) { ?>
                  <?php if ($editor['code'] == $config_admin_editor) { ?>
                  <option value="<?php echo $editor['code']; ?>" selected="selected"><?php echo $editor['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $editor['code']; ?>"><?php echo $editor['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select></td>
            </tr>
