        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="config_image_article_width" value="<?php echo $config_image_article_width; ?>" size="3" />
                x
                <input type="text" name="config_image_article_height" value="<?php echo $config_image_article_height; ?>" size="3" />
                <?php if ($error_image_product) { ?>
                <span class="help-inline error"><?php echo $error_image_article; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_image_article_category; ?></td>
              <td><input type="text" name="config_image_article_category_width" value="<?php echo $config_image_article_category_width; ?>" size="3" />
                x
                <input type="text" name="config_image_article_category_height" value="<?php echo $config_image_article_category_height; ?>" size="3" />
                <?php if ($error_image_article_category) { ?>
                <span class="help-inline error"><?php echo $error_image_article_category; ?></span>
                <?php } ?></td>
            </tr>
          </table>
        </div>
