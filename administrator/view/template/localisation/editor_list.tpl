      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($editor['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $editor['name']; ?></td>
              <td class="left"><?php echo $editor['code']; ?></td>
              <td class="right"><?php echo $editor['sort_order']; ?></td>
              <td class="right"><?php foreach ($editor['action'] as $action) { ?>
