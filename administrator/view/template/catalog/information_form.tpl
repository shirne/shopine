        ...
        <table class="form">
          <tr>
              ...
              <td><select name="category_id">
                  ...
                  <?php if ($category['information_category_id'] == $category_id) { ?>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="information_description[<?php echo $language['language_id']; ?>][description]" class="editor"><?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['description'] : ''; ?></textarea>
