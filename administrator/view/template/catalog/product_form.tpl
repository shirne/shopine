          ...
          <div id="language-general<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][description]" class="editor"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
              <tr>
     ...
     <?php } ?>
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'text' || $product_option['type'] == 'checkbox') { ?>
          ...
          <table id="option-value<?php echo $option_row; ?>" class="list">
            ...
            <?php if($product_option['type']=='union_option'){ ?>
            <table id="option-value<?php echo $option_row; ?>" class="list">
                <thead>
                <tr>
                    <td class="right"><?php echo $entry_quantity; ?></td>
                ...
                <tr>
                    <td class="left" colspan="4">
                        <script type="text/javascript">
                            jQuery(function($) {
                                setOptionRow(<?php echo $option_value_row; ?>,<?php echo $option_row;?>,<?php echo json_encode($product_option_value['product_value'],TRUE);?>);
                            });
                        </script>
                        <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][product_option_value_id]" value="<?php echo $product_option_value['product_option_value_id']; ?>" /></td>
                </tr>
                <tr>
                    <td class="right"><input class="span1" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][quantity]" value="<?php echo $product_option_value['quantity']; ?>" size="3" /></td>
                    <td class="left"><select  class="span1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract]">
                            <option value="1" <?php echo isSelected($product_option_value['subtract'],1);?>><?php echo $text_yes; ?></option>
                            <option value="0" <?php echo isSelected($product_option_value['subtract'],0);?>><?php echo $text_no; ?></option>
                        </select></td>
                    <td class="right"><select  class="span1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]">
                            <option value="+" <?php echo isSelected($product_option_value['price_prefix'],'+');?>>+</option>
                            <option value="-" <?php echo isSelected($product_option_value['price_prefix'],'-');?>>-</option>
                        </select>
                        <input type="text"  class="span1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price]" value="<?php echo $product_option_value['price']; ?>" size="5" /></td>
                    <td class="right"><select   class="span1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points_prefix]">
                            <option value="+" <?php echo isSelected($product_option_value['points_prefix'],'+');?>>+</option>
                            <option value="-" <?php echo isSelected($product_option_value['points_prefix'],'-');?>>-</option>
                        </select>
                        <input type="text" class="span1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points]" value="<?php echo $product_option_value['points']; ?>" size="5" /></td>
                ...
                <tr>
                    <td colspan="4"></td>
                    <td class="left"><a onclick="addOptionUnionValue('<?php echo $option_row; ?>');" class="button"><span><?php echo $button_add_option_value; ?></span></a></td>
                </tr>
                </tfoot>
            </table>
          ...
          <?php $option_value_row = 0; ?>
      <?php foreach ($product_options as $product_option): ?>
          <?php if (in_array($product_option['type'], array('select', 'radio', 'checkbox', 'color', 'text', 'virtual_product','union_option') )): ?>
      <?php foreach ($product_option['product_option_value'] as $product_option_value) : ?>
                          <?php if($product_option['type']!='union_option'):?>
...
$('input[name=\'option\']').autocomplete({
  ...
  select: function(event, ui) {
    ...
    if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'text' || ui.item.type == 'checkbox') {
    ...
    if (ui.item.type == 'virtual_product' ) {
      ...
      html += '</div>';
        ...
        if (ui.item.type == 'union_option' ) {
            ...
            html += '        <td class="left"><a onclick="addOptionUnionValue(' + option_row + ');" class="button"><span><?php echo $button_add_option_value; ?></span></a></td>';
            html += '      </tr>';
            html += '    </tfoot>';
            html += '  </table>';
            html += '</div>';
...
function addOptionVirtualValue(option_row) {
  ...
  option_value_row++;
    option_virtual_value_row++;
}
//--></script>

<script type="text/javascript"><!--
    var option_union_value_row = <?php echo $option_value_row; ?>;
    var loadstat=0;//0 未加载,1 在加载, 2 已加载
    var loadcallback=[];
    var union_raw=[];

    function addOptionUnionValue(option_row) {
        html  = '<tbody id="option-value-row' + option_value_row + '">';
        html += '  <tr>';
        html += '    <td class="left" colspan="4">';
        html += '<input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][product_option_value_id]" value="" />';
        html +=         '</td>';
        html += '    <td class="left" rowspan="2"><a onclick="$(\'#option-value-row' + option_union_value_row + '\').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>';
        html += '  </tr>';
        html += '  <tr>';
        html += '    <td class="right"><input class="span1" type="text" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][quantity]" value="" size="3" /></td>';
        //html += '    <td class="right"><input class="span2" type="text" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][product_value]" value="" size="20" /></td>';
        html += '    <td class="left"><select class="span1" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][subtract]">';
        html += '      <option value="1"><?php echo $text_yes; ?></option>';
        html += '      <option value="0"><?php echo $text_no; ?></option>';
        html += '    </select></td>';
        html += '    <td class="right"><select class="span1" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][price_prefix]">';
        html += '      <option value="+">+</option>';
        html += '      <option value="-">-</option>';
        html += '    </select>';
        html += '    <input type="text" class="span1"  name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][price]" value="" size="5" /></td>';
        html += '    <td class="right"><select name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][points_prefix]">';
        html += '      <option value="+">+</option>';
        html += '      <option value="-">-</option>';
        html += '    </select>';
        html += '    <input type="text" class="span1" name="product_option[' + option_row + '][product_option_value][' + option_union_value_row + '][points]" value="" size="5" /></td>';
        ...
        setOptionRow(option_value_row,option_row);

        option_value_row++;
        option_union_value_row++;
    }

    function setOptionRow(rownum,optrow,value){
        if(!value)value=[];
        if(loadstat==0){
            loadstat=1;
            $.ajax({
                url:'index.php?route=catalog/product/unionOption&token=<?php echo $token; ?>&option_id=' + $('input[name=\'product_option[' + optrow + '][option_id]\']').attr('value'),
                dataType:'json',
                success:function(j){
                    union_raw=j;
                    loadstat=2;
                    setOptionRow(rownum,optrow,value);
                    while(func=loadcallback.pop()){
                        func();
                    }
                }
            });
        ...
        var row=$('#option-value-row'+rownum);
        var input=row.find('td input').eq(0);
        for(var i=0;i< union_raw.length;i++){
            var select='<label class="inline">'+union_raw[i].description+'<select class="inline" name="product_option['+optrow+'][product_option_value]['+rownum+'][product_value]['+union_raw[i].name+']">';
            var data=union_raw[i].data;
            for(var j=0;j<data.length;j++){
                select+='<option value="'+data[j].option_value_id+'" '+(value[union_raw[i].name]==data[j].option_value_id?'selected':'')+'>'+data[j].name+'</option>';
            }
            select+='</select></label><input type="hidden" name="product_option['+optrow+'][product_option_value]['+rownum+'][option_value_id]" value="'+union_raw[i].option_value_id+'" />';
            input.before(select);
        }
