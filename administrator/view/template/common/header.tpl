  ...
  <li class="dropdown" id="h_extension">
	  ...
	  <ul class="dropdown-menu">
		<li><a href="<?php echo $module; ?>"><?php echo $text_module; ?></a></li>
          ...
          <li><a href="<?php echo $flink; ?>"><?php echo $text_flink; ?></a></li> 
 ...
 <ul class="nav pull-right">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
		     <li><a href="http://www.shopine.cn/guide">新手向导</a></li>
		     <li><a href="http://www.shopine.cn/developer">开发文档</a></li>
		     <li><a href="http://www.shopine.cn/video">使用视频</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.shopine.cn/support" >商业支持</a></li>
		     <li><a href="http://www.shopine.cn/contact-us" >合作洽谈</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.shopine.cn/about-us" >团队介绍</a></li>
		 	 <li><a href="http://bbs.shopine.cn/" >支持论坛</a></li>
		 	 <li><a href="http://www.shopine.cn/" >官方网站</a></li>
		  </ul>
		</li>
		<?php } ?>
		<li class="dropdown">
