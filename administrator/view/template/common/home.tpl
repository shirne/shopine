        ...
        <div class="dashboard-content">
          ...
          <dl>
            <dt><?php echo $text_article; ?></dt>
                <dd><a href="<?php echo $add_article_category; ?>"><?php echo $text_add_article_category; ?></a></dd>
                <dd><a href="<?php echo $article_category; ?>"><?php echo $text_article_category; ?></a></dd>
                <dd><a href="<?php echo $add_article; ?>"><?php echo $text_add_article;?></a> </dd>
                <dd><a href="<?php echo $article; ?>"><?php echo $text_article; ?></a></dd>
          </dl>
        	<dl>
