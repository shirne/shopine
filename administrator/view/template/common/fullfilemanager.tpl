...
#column-left { background: #FFF; border: 1px solid #CCC; float: left; width: 20%; height: 600px; overflow: auto; }
#column-right { background: #FFF; border: 1px solid #CCC; float: right; width: 78%; height: 600px; overflow: auto; text-align: center; }
