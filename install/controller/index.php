...
if ($config->get('config_ssl')) {
	define('HTTPS_SERVER', 'https://www.shopine.cn/');
	define('HTTPS_IMAGE', 'https://www.shopine.cn/image/');
} else {
	define('HTTPS_SERVER', 'http://www.shopine.cn/');
	define('HTTPS_IMAGE', 'http://www.shopine.cn/image/');
}
